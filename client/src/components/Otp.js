...
import { generateLoginOTP, verifyOTP } from '../helper/helper';
...
export default function Otp() {
  ...
  useEffect(() => {
    generateLoginOTP(username).then((OTP) => {
      console.log(OTP)
  ...
  function resendOTP(){
    ...
    let sentPromise = generateLoginOTP(username);
      ...
      <div className='flex justify-center items-center h-screen'>
        <div className={styles.glass}>
          ...
          <div className="title flex flex-col items-center">
            <h4 className='text-5xl font-bold'>Verify Account</h4>
